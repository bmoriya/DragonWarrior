...
from src.common import Direction, parse_animated_spritesheet
...
class TestAnimatedSprite(TestCase):
    def setUp(self) -> None:
        ...
        self.anim_sprite = AnimatedSprite(center_point=None, direction=None, down_images=None, name='Mock')
